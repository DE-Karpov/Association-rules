...
class AssocRules:
    ...
    def get_apriori(self, params):
      rules = list(apriori(self.transactions, min_support = params["min_support"][0], min_confidence = params["min_confidence"][0], min_lift = params["min_lift"][0], max_length = params["max_length"][0]))
